...
const RegisterScreen = ({ navigation }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput placeholder='Your Name' style={styles.inputContainer} value={nombre} onChangeText={setNombre} />
      <TextInput placeholder='Your Email' style={styles.inputContainer} value={email} onChangeText={setEmail} />
      <TextInput
      ...
      <View style={styles.inputContainer}>
        <Icon name='calendar-outline' size={20} color='#6B7280' style={styles.icon} />
        <TextInput
